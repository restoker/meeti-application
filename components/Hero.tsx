...
const Hero = () => {
    ...
    useGSAP(() => {
        ...
        tl.to(bgCyanRef.current, {
            duration: 1,
            width: "100%",
        })
            .to(bgAmberRef.current, {
                duration: 1,
                width: "100%",
            }, '<')
    ...
    return (
        <div ref={bgAmberRef} className="bg-linear-to-b from-amber-200 to-amber-50 dark:bg-gray-900">
            <div className="relative isolate overflow-hidden bg-linear-to-b from-amber-100/20 dark:from-amber-950/10">
                <div
                    ref={bgCyanRef}
                    aria-hidden="true"
                    className="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-cyan-100 shadow-xl ring-1 shadow-amber-600/10 ring-amber-50 sm:-mr-80 lg:-mr-96 dark:bg-gray-800/30 dark:shadow-amber-400/10 dark:ring-white/5"
                />
                <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8 overflow-hidden">
                        ...
                        <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
                            <p ref={subTitleRef} className="text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
                                Conecta con personas que comparten tus pasiones. Desde hiking hasta tecnología, hay un Meeti esperándote.
                            </p>
                            <div className="mt-10 flex items-center gap-x-6">
                                <Link
                                    href="/register"
                                    className="rounded-md bg-amber-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-amber-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500 dark:bg-amber-400 dark:hover:bg-amber-300 dark:focus-visible:outline-amber-400"
                                >
                                    Crear cuenta
                                </Link>
                        ...
                        /> */}
                        <video ref={videoRef} autoPlay loop muted src="https://cdn.cosmos.so/a58329ab-bf40-4b68-941a-649ab1a00def.mp4" className="mt-10 aspect-6/5 w-full max-w-lg rounded-2xl object-cover outline-1 -outline-offset-1 outline-black/5 sm:mt-16 lg:mt-0 lg:max-w-none xl:row-span-2 xl:row-end-2 xl:mt-36 dark:outline-white/10 p-2"></video>
                    </div>
                </div>
